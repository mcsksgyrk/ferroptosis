...
#core_df = pd.read_csv("./prlists/core_proteins.csv")
#
#
#op_interact.columns
#core_df.columns
...
#    print(row.UniProtAC)
#    pathways.append(reactome_client.map_protein_to_pathways(row.UniProtAC))
#
#core_df['pathways'] = pathways
#core_df['pathways'] = core_df['pathways'].apply(lambda x: ';'.join(x))
#core_df.to_csv('./prlists/all_col_core_df.csv')
